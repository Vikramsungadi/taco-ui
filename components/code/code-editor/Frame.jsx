...
const Frame = forwardRef(function Frame({ html, css, javascript, className, style, size, ...props }, ref) {
	const alignment = {
...
<html class='w-full ${props.dark ? "dark" : "light"}'  >
	<head>
		...
		<body  class='flex ${alignment[props.center]} gap-4 w-full h-full bg-white dark:bg-black'>
