...
const Hero = () => {
	...
	const Span = ({ children, delay, className }: { children?: React.ReactNode; delay?: string; className?:string; }) => (
		<span
	...
	return (
		<section
			style={hueAnimVars}
			className='relative z-10 flex-col flex animate-filter-color  items-center justify-center gap-6 text-center max-md:py-14 md:py-16 lg:py-[5.25rem]'>
			<h1 className='z-10 mx-4 max-w-3xl text-[4rem]/[4rem]  font-bold max-md:text-5xl' style={{ textWrap: "balance" } as CSSProperties}>
