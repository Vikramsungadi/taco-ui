...
const Nav = () => {
	return (
		<header
			...
			<Link href='/' aria-label='navigate to home' className='-translate-y-1 font-sans text-3xl font-semibold'>
				<Logo className='aspect-[97/33] h-8 translate-y-0.5' />
			</Link>
			<nav className='group flex items-center justify-center gap-6 text-sm font-semibold '>
				<Link href='/components' className='cursor-pointer transition-colors hover:text-sky-500 dark:hover:text-zinc-50 '>
					Components
				</Link>
				<ThemeButton>
